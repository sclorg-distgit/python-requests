...
BuildRequires:  %{?scl_prefix}python%{python3_pkgversion}-urllib3
...
BuildRequires:  %{?scl_prefix}python%{python3_pkgversion}-pytest-httpbin
...
%changelog
* Thu Feb 06 2020 Tomas Orsava <torsava@redhat.com> - 2.22.0-10
